...
The Category Column was tested up to WP 3.1. It should work with versions down to 2.7 but was never tested on those.

== Installation ==

1. Upload the `category_column` folder to the `/wp-content/plugins/` directory
